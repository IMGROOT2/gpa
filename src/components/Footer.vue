<template>
  <div
    class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center justify-center text-center"
  >
    <span class="text-sm text-gray-500 text-center dark:text-gray-400"
      ...
      <a
        ...
        >Siddhant Kameswar</a
      >
      - Not affiliated with Round Rock Independent School District.
    </span>
    <a
      target="_blank"
      href="https://github.com/IMGROOT2/gpa"
      class="justify-center flex items-center mt-3 sm:mt-0"
